  ...
  return (
    <div className="w-full bg-slate-50 min-h-screen font-sans animate-fade-in">
      ...
      <div className="container mx-auto px-4 py-12 max-w-5xl">
        ...
        {/* 2. INTRODUCCIÓN */}
        <section className="bg-white p-8 rounded-2xl shadow-sm border border-slate-100 mb-12 relative overflow-hidden">
        ...
        {/* --- SECCIÓN MULTIMEDIA (2 Presentaciones) --- */}
        <section className="mb-16">
            ...
            {/* PRESENTACIÓN 1: HISTORIA DEL ARTE */}
            <div className="w-full bg-white border border-slate-200 p-2 md:p-4 rounded-3xl shadow-xl overflow-hidden flex flex-col">
                <div className="mb-4 px-2 flex items-center gap-2">
                    ...
                    <h3 className="text-slate-900 font-bold">Historia del Arte para la Educación</h3>
                </div>
                <div style={{ width: '100%' }}>
                <div style={{ position: 'relative', paddingBottom: '56.25%', paddingTop: 0, height: 0 }}>
                    <iframe 
                    title="Historia del Arte para la Educación" 
                    frameBorder="0" 
                    width="1200" 
                    height="675" 
                    style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', borderRadius: '12px' }} 
                    src="https://view.genially.com/69177689ea33a9cc40a4fe10" 
                    allowFullScreen={true}
                    scrolling="yes" 
                    /> 
                </div> 
                </div>
                <div className="mt-4 text-center text-slate-600 text-sm flex items-center justify-center gap-2">
                    <PlayCircleIcon className="h-5 w-5"/> <span>Ver Presentación</span>
                </div>
            </div>

            {/* PRESENTACIÓN 2: ANTIGUA EDUCA */}
            <div className="w-full bg-white border border-slate-200 p-2 md:p-4 rounded-3xl shadow-xl overflow-hidden flex flex-col">
                <div className="mb-4 px-2 flex items-center gap-2">
                    <div className="w-8 h-8 rounded-full bg-blue-500 text-white flex items-center justify-center font-bold text-sm">2</div>
                    <h3 className="text-slate-900 font-bold">Presentación Antigua Educa</h3>
                </div>
                <div style={{ width: '100%' }}>
                <div style={{ position: 'relative', paddingBottom: '56.25%', paddingTop: 0, height: 0 }}>
                    <iframe 
                    title="PRESENTACIÓN ANTIGUA _EDUCA" 
                    frameBorder="0" 
                    width="1200" 
                    height="675" 
                    style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', borderRadius: '12px' }} 
                    src="https://view.genially.com/64dd81dbe53d5700112b0946" 
                    allowFullScreen={true}
                    scrolling="yes" 
                    /> 
                </div> 
          ...
          <div className="relative border-l-4 border-slate-200 ml-4 md:ml-6 space-y-12">
            {hitos.map((hito, index) => (
              <div key={index} className="relative pl-8 md:pl-12">
                <div className="absolute -left-2.75 top-0 w-6 h-6 bg-white border-4 border-slate-300 rounded-full"></div>
